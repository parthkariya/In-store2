...
import { AiOutlineClose, AiOutlineEye, AiOutlineEyeInvisible, AiOutlineGoogle } from "react-icons/ai";
...
const Navbar = (
  ...
  const SigninCustomer = async (type) => {
    ...
    if (getfirstname === "") {
      ...
      alert("Enter the Email......!");
      return;
    } else if (getRegioncus === "") {
      alert("Enter the Region......!");
      return;
      ...
      >
        <div className="home_login_model_1sec_inner">
          ...
          <div className="sign_input_wrapp">
            ...
            <div style={{ background: "#DAD9D8", paddingTop: "0.4rem", paddingBottom: "0.4rem", paddingLeft: "1rem", paddingRight: "1rem", display: "flex", alignItems: "center" }} className="input_box-cus-pass">
              <input
          ...
          <div className="sign_input_wrapp">
            ...
            <div style={{ background: "#DAD9D8", paddingTop: "0.4rem", paddingBottom: "0.4rem", paddingLeft: "1rem", paddingRight: "1rem", display: "flex", alignItems: "center" }} className="input_box-cus-pass">
              ...
              {passwordVisible1 === true ?
                ...
                <AiOutlineEye size={22} onClick={togglePasswordVisibility1}>{passwordVisible1 ? 'Hide' : 'Show'}</AiOutlineEye>
                :
                <AiOutlineEyeInvisible size={22} onClick={togglePasswordVisibility1} >{passwordVisible1 ? 'Hide' : 'Show'}</AiOutlineEyeInvisible>
